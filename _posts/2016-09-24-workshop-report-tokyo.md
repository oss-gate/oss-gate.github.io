...
GoogleやFacebookに所属している凄いハッカーが、ネットを介してバリバリとコードを書いているとか、イケてるWebサービスのCTOが、華麗なパッチを次々と投稿しているとか、あるいは、コンピュータサイエンスの天才的な研究者が、秘蔵のライブラリの一部をネットで公開しているといった感じでしょうか。
...
ビギナーが選んだ題材について、メンターが詳しくないこともあるのですが、レポートの粒度を小さくしたり、開発版と安定版のリポジトリを確認したり、パッチの送り方を調べたりと、開発プロジェクトに参加してきたからこそ気づくポイントもあります。逆に、題材のOSSを知っていると、逆に教えすぎないように我慢するのが大変だそうです。「詳しく知らなくても、ビギナーの半歩先を行くぐらいが、ちょうどいい感じだ」というのが印象的でした。
